...
struct AppointmentAttendance : Codable {
	...
	let i_created : Int?
	let i_updated : Int?
	let fk_created_by_id : String?
	let fk_updated_by_id : String?
...
extension AppointmentAttendance {
    ...
    init(from decoder: Decoder) throws {
        ...
        fk_created_by_id = try values.decodeIfPresent(String.self, forKey: .fk_created_by_id)
        fk_updated_by_id = try values.decodeIfPresent(String.self, forKey: .fk_updated_by_id)
