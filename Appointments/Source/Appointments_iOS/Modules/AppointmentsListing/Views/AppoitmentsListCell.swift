...
class AppoitmentsListCell: RxUITableViewCell {
    ...
    fileprivate lazy var room_label: UILabel = {
        ...
        label.text = "Room #101"
        label.translatesAutoresizingMaskIntoConstraints = false
        label.textColor = UIColor(named: "color_appointments_dark_gray", in: Bundle(for: AppoitmentsListCell.self), compatibleWith: .none)
    ...
    fileprivate lazy var checkbox_button : UIButton = {
        ...
        checkbox_button.setImage(UIImage(named: "icon_appointments_checkbox_unselected", in: Bundle(for: AppoitmentsListCell.self), compatibleWith: .none), for: .normal)
        checkbox_button.setImage(UIImage(named: "icon_appointments_checkbox_selected", in: Bundle(for: AppoitmentsListCell.self), compatibleWith: .none), for: .selected)
    ...
    fileprivate lazy var arrow_image : UIImageView = {
        let view = UIImageView(frame: CGRect.zero)
        view.image = UIImage(named: "icon_appointments_date_right", in: Bundle(for: AppoitmentsListCell.self), compatibleWith: .none)
        view.backgroundColor = UIColor.white
        view.translatesAutoresizingMaskIntoConstraints = false
        return view
    }()
    ...
    fileprivate lazy var line_view : UIView = {
        ...
        view.backgroundColor = UIColor(named: "color_appointments_light_gray", in: Bundle(for: AppoitmentsListCell.self), compatibleWith: .none)
        view.translatesAutoresizingMaskIntoConstraints = false
        return view
    }()
    ...
    private func setupViews() {
        ...
        contentView.backgroundColor = UIColor(named: "color_appointments_light_gray", in: Bundle(for: AppoitmentsListCell.self), compatibleWith: .none)
    }
